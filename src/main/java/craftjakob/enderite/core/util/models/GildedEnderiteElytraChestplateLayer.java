...
public class GildedEnderiteElytraChestplateLayer<T extends LivingEntity, M extends EntityModel<T>> extends RenderLayer<T, M> {
	   private static final ResourceLocation WINGS_LOCATION = new ResourceLocation(Enderite.MODID, "textures/entity/gilded_enderite_elytra_chestplate.png");
	   private final ElytraModel<T> elytraModel;
	
	   public GildedEnderiteElytraChestplateLayer(RenderLayerParent<T, M> p_174493_, EntityModelSet p_174494_) {
		      super(p_174493_);
		   ...
		   public boolean shouldRender(ItemStack stack, T entity) {
		      return stack.getItem() == ModItems.GILDED_ENDERITE_ELYTRA_CHESTPLATE.get();
		   }
