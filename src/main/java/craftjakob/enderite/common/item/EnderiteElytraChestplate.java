...
public class EnderiteElytraChestplate extends ArmorItem {
    public EnderiteElytraChestplate(ArmorMaterial material, Type slot, Properties properties) {
        super(material, slot, properties);
        DispenserBlock.registerBehavior(this, EnderiteElytraChestplate.DISPENSE_ITEM_BEHAVIOR);
    }
    // Gilded Enderite Armor
    @Override
    ...
    public static boolean isFlyEnabled(ItemStack p_41141_) {
     ...
     public void appendHoverText(ItemStack stack, Level level, List<Component> components, TooltipFlag tooltipFlag) {
     	{
     		components.add(Component.translatable("tooltip.enderite.enderite_elytra_chestplate.description").withStyle(ChatFormatting.BLUE));
     	} 
